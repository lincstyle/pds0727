				...
				var htmlToAdd = 
					"<div class='ms2side__div'>" +
						...
						"<div class='ms2side__select'>" +
							...
							"<select title='" + o.labelsx + "' name='" + nameSx + "' id='" + nameSx + "' size='" + "10" + "' multiple='multiple' ></select>" +
						"</div>" +
						"<div class='ms2side__options'>" +
							((o.selectedPosition == 'right')
							?
							("<p class='AddOne' title='Add Selected'>添加</p>" +
							"<p class='AddAll' title='Add All'>全部添加</p>" +
							"<p class='RemoveOne' title='Remove Selected'>取消</p>" +
							"<p class='RemoveAll' title='Remove All'>全部取消</p>")
							:
						...
						"<div class='ms2side__select'>" +
							...
							"<select title='" + o.labeldx + "' name='" + nameDx + "' id='" + nameDx + "' size='" + "10" + "' multiple='multiple' ></select>" +
						"</div>" +
						((o.selectedPosition == 'right' && o.moveOptions) ? divUpDown : "") +
					"</div>";
