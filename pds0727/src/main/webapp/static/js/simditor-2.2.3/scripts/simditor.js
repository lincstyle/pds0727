...
var AlignmentButton, BlockquoteButton, BoldButton, Button,  ColorButton, Formatter, HrButton, IndentButton, Indentation, InputManager, ItalicButton, Keystroke, ListButton, OrderListButton, OutdentButton, Popover, Selection, Simditor, StrikethroughButton,  TitleButton, Toolbar, UnderlineButton, UndoManager, UnorderListButton, Util,
...
Button = (function(superClass) {
  ...
  Button.prototype._tpl = {
    item: '<li><a tabindex="-1" unselectable="on" class="toolbar-item" href="javascript:;"><i></i></a></li>',
  ...
  Button.prototype.setIcon = function(icon) {
    /*设置按钮图标*/
    return this.el.find('i').removeClass().addClass(this.iconClassOf(icon)).text(this.text);
  };
...
TitleButton = (function(superClass) {
  ...
  TitleButton.prototype.icon = 'header';
